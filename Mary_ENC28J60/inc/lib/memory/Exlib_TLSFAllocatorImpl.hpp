...
class TLSF_AllocatorImpl : public RefCount
{    
private:
//
// Debug functions
...
//      return (size & mask) >> rs;
    ...
    exlib::Array<BoundaryTagBegin*> mFreeBlock; //! freeblock list
    uint32_t mFreeListBitFLI;                   //! FLI の freelist flag
    exlib::Array<uint32_t> mFreeListBitSLI;     //! SLI の freelist flag
};
}
